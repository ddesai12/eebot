...
EFUPPERTHRES        EQU   $D0;$90;$A0;$70;set to 3V
EFLOWERTHRES        EQU   $A0;$70;$70;$40;set to 2V

DTHRES              EQU   $70;$C0;$70;$60
ATHRES              EQU   $70;$A0;$70
BTHRES              EQU   $70;$90;$60
CTHRES              EQU   $C0;$60;$60                            
...
DIRECTION       DC.B 0        ; initialize 1-byte DIRCTION to $00
...
ESTAT               RMB   1
FSTATUS             RMB   1
;EFUPPERTHRES        RMB   1;$90;$A0;$70;set to 3V
;EFLOWERTHRES        RMB   1;$70;$70;$40;set to 2V

;DTHRES              RMB   1;$C0;$70;$60
;ATHRES              RMB   1;$A0;$70
;BTHRES              RMB   1;$90;$60
;CTHRES              RMB   1;$60;$60 
  ORG $4000
...
;---------------------------------------------------------------------------
;               Display Sensors
;MAAAIN          BRCLR PORTAD0,%00000100,MAIN
;                BRA   MAAAIN
;MAIN            JSR PORTON
;                JSR STARON
;                
...
;MAIN                BRCLR PORTAD0,%00000100,BEGIN
;                    BRA   MAIN  
...
DISPATCHER          LDAA  CURRENT_STATE
                    ...
                    JSR   WAITING_STATE
                    RTS
NOT_WAITING         LDAA  CURRENT_STATE
                    CMPA  #EFLOOP
                    BNE   NOT_FORWARD
                    JSR   EF_LOOP
                    RTS
NOT_FORWARD         LDAA  CURRENT_STATE
                    ...
                    JSR   REV_STATE
                    RTS                 
NOT_STATE1          LDAA  CURRENT_STATE
                    CMPA  #LL
                    BNE   NOT_STATE2
                    JSR   LL_STATE
                    RTS
 
NOT_STATE2          LDAA  CURRENT_STATE
                    CMPA  #RR
                    BNE   NOT_STATE3
                    JSR   RR_STATE
                    RTS                   
                    
NOT_STATE3          LDAA  CURRENT_STATE
                    CMPA  #LHT
                    BNE   NOT_STATE4
                    JSR   CHGSTATELHT
                    RTS
NOT_STATE4          LDAA  CURRENT_STATE
                    CMPA  #RHT
                    BNE   NOT_STATE5
                    JSR   CHGSTATERHT
                    RTS
NOT_STATE5          LDAA  CURRENT_STATE
                    CMPA  #TURN
                    BNE  NOT_STATE6
                    JSR  TURN_STATE                    
                                        
NOT_STATE6          JSR   CHGSTATE
                    SWI
RESTART             LDAA  #EFLOOP
                    STAA  CURRENT_STATE
                    BRA   DISPATCHER 
...
;                    BGE   CSTATE
                    ...
                    ;Do EFsensor voltage - EFUPPERTHRES. if>0, F has hit black line and jump to RR in dispatcher, otherwise stay here
                    ;Do EFsensor voltage - EFLOWERTHRES. if<0, E has hit the black line and jump to LL in dispatcher, otherwise stay here                  
                    
                    
                    ;Do Dsensor voltage - THRES. if>0, D has hit black line, change DSTAT to 1.          SENSOR_STBD
                    ;Do Bsensor voltage - THRES. if>0, B has hit black line, change BSTAT to 1.          SENSOR_PORT
                    ;Do Asensor voltage - THRES. if>0, A has hit black line, change ASTAT to 1.          SENSOR_MID
                    ;Do Csensor voltage - THRES. if>0, C has hit black line,, change CSTAT to 1.         SENSOR_BOW
                    
                    ;otherwise, stay here and keep looping in FWD_STATE                                
